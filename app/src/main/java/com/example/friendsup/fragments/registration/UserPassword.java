 ...
 * Use the {@link UserPassword#newInstance} factory method to
...
public class UserPassword extends Fragment {
    ...
    public static UserPassword newInstance(String param1, String param2) {
        UserPassword fragment = new UserPassword();
